...
def get_parser():
    ...
    parser.add_argument('--beam', type=int, default=-1,
                        help='beam size. -1 means no beam search')
    ...
    parser.add_argument('--load_jpeg', dest='use_lmdb', action='store_false',
                        help='load images from jpg instead of lmdb')
    ...
    parser.add_argument('--use_true_ingrs', dest='use_true_ingrs', action='store_true',
                        help='use true ingredients during evaluation')
    parser.set_defaults(use_true_ingrs=False)

    # ✅ التعديل المهم عشان يشتغل في VS Code / Jupyter
